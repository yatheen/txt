...
else if (BodyofMessage.toLowerCase().indexOf('laser') > -1)
{
    interests='LASER';
    dob=BodyofMessage.toLowerCase().split('laser')[0];
}
else if (BodyofMessage.toLowerCase().indexOf('$5arcade') > -1)
{
    interests='$5ARCADE';
    dob=BodyofMessage.toLowerCase().split('$5arcade')[0];
}
